...
import { Home, Register, Login, Navbar, UsersOnly, Admin, Recover, SetPassword, Application } from "./Components/index";
...
function App() {
    return (
        <Router>
            ...
            <AdminRoute exact path="/application" component={Application}/>
