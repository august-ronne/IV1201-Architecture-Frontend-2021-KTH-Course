...
3. Edit the `proxy` property of the file `package.json` so that the port matches the local development port you chose for the back-end.

## 4. Run Front-end in Development Environment
...
## 5. Run Front-end Tests in Development Environment
